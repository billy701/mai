...
public class MainChargeFace extends JFrame{

	private RecordChargeFace recordFace;
	private BaseChargeStaffFace baseStaffFace;
	private CheckInChargeFace checkInJFrame;
	private static MainChargeFace mainFace;
	
	public static MainChargeFace getInstance()
	{
		if( mainFace == null)
			mainFace = new MainChargeFace();
		return mainFace;
	}
...
public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainChargeFace frame =getInstance();
	...
	private MainChargeFace() {
		...
		RecordButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				recordFace = RecordChargeFace.getInstance();
		...
		CheckInButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				checkInJFrame = CheckInChargeFace.getInstance();
		...
		StaffButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				baseStaffFace = BaseChargeStaffFace.getInstecne();
