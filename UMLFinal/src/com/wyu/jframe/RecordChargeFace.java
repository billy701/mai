...
public class RecordChargeFace extends JFrame{
	...
	private static RecordChargeFace recordFace;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RecordChargeFace frame = getInstance();
	...
	public static RecordChargeFace getInstance()
	{
		if(recordFace == null)
			recordFace = new RecordChargeFace();
		return recordFace;
	}
	
	private RecordChargeFace() {
		...
		lblNewLabel.setFont(new Font("ª™ŒƒÁ˙ÁÍ", Font.ITALIC, 35));
		...
		ReturnButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.ITALIC, 12));
