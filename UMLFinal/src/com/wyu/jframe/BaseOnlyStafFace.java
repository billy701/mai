...
public class BaseOnlyStafFace extends JFrame{

	private JTextField NameField;
	private JTextField PassWordField;
	private JTextField PayField;
	private JTextField DutyField;
	private MainStaffFace mainFace;
	private List<Staff> listaccount;
	private BaseStaffManager baseStaffManager;
	private static BaseOnlyStafFace baseOnlyStafFace;
	
	public static BaseOnlyStafFace getInstecne()
	{
		if(baseOnlyStafFace == null)
			baseOnlyStafFace = new BaseOnlyStafFace();
		return baseOnlyStafFace;
	}
...
public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BaseOnlyStafFace frame =getInstecne();
	 ...
	 private BaseOnlyStafFace() {
		 baseStaffManager = BaseStaffManager.getInstance();
			...
			ReturnButton.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					mainFace = MainStaffFace.getInstance();
