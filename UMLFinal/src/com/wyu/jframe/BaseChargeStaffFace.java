...
public class BaseChargeStaffFace extends JFrame{
	...
	private static BaseChargeStaffFace baseChargeStaffFace;
	
	public static BaseChargeStaffFace getInstecne()
	{
		if(baseChargeStaffFace == null)
			baseChargeStaffFace = new BaseChargeStaffFace();
		return baseChargeStaffFace;
	}
...
public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BaseChargeStaffFace frame =getInstecne();
